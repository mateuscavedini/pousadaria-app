...
describe 'Hóspede altera status de uma reserva' do
  it 'para cancelado' do
    ...
    booking = Booking.create!(start_date: 7.days.from_now, finish_date: 10.days.from_now, guests_number: 2, total_price: room.calculate_total_price(1.day.from_now.to_date, 5.days.from_now.to_date), room: room, guest: guest, status: :pending)
