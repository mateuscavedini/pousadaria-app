...
describe 'Proprietário altera status de um quarto' do
  it 'para ativo' do
    ...
    Room.create!(name: 'Primeiro Quarto', description: 'Primeiro quarto a ser cadastrado', area: 50, max_capacity: 2, daily_rate: 100, has_bathroom: true, has_balcony: false, has_air_conditioner: true, has_tv: true, has_wardrobe: true, has_safe: true, is_accessible: true, guesthouse: guesthouse, status: :inactive)
    ...
    expect(page).to have_content 'O quarto foi ativado com sucesso.'
  ...
  it 'para inativo' do
    ...
    expect(page).to have_content 'O quarto foi desativado com sucesso.'
